function promocao() {
    ...
    var pgto = document.getElementsByName('pgto').value;
    ...
    document.getElementById('saida').innerHTML = "Parabéns, tu comprou " + qtd + "Kg de " + tipo[indiceTipo] + "  no valor de R$" + resultado;
